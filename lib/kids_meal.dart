...
class KidsMeal extends StatelessWidget {
  const KidsMeal({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Kids Meal Menu'),
        backgroundColor: const Color.fromRGBO(180, 122, 92, 1), // Warna untuk AppBar
        centerTitle: true,
      ),
      body: FutureBuilder<List<dynamic>>(
        future: ApiService().getCustomKidsMenu(), // API untuk kategori "Menu Utama"
